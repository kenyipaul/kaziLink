    ...
    useEffect(() => {
        ...
        Axios({
            ...
            if (res.data.status === "success") {
                ...
                sessionStorage.setItem("_kazi_jobs", JSON.stringify(res.data.data.jobs));
            }
        })
            ...
            <div className="jobs-page">
                <div className="jobs-page-content">
                    ...
                    <div className="top-bar">
                        ...
                        <div className="tags">
                            <button onClick={() => setFilter(0)} className={filter === 0 && "active"} >Most Recent</button>
                            <button onClick={() => setFilter(1)} className={filter === 1 && "active"} >Most Applications</button>
                            <button onClick={() => setFilter(2)} className={filter === 2 && "active"} >Highest Pay</button>
                            <button onClick={() => setFilter(3)} className={filter === 3 && "active"} >Near Me</button>
                            <button onClick={() => setFilter(4)} className={filter === 4 && "active"} >Full time</button>
                        </div>
                    </div>
