        ...
        <div className="dash-reports">
          ...
          <div className="report">
            ...
            >
              ...
              <path
                opacity="0.5"
                d="M24.9126 34.175C24.325 34.8017 23.3406 34.8335 22.7139 34.2459C22.0871 33.6583 22.0554 32.6739 22.6429 32.0472L28.4763 25.8249C29.0445 25.2188 29.9888 25.1662 30.6208 25.7056L35.2249 29.6343L41.2235 22.0361C41.7559 21.3618 42.734 21.2467 43.4083 21.779C44.0826 22.3114 44.1977 23.2895 43.6654 23.9638L36.6654 32.8305C36.1186 33.5231 35.1059 33.6227 34.4347 33.0499L29.7306 29.0358L24.9126 34.175Z"
                fill="#4AD991"
              />
            </svg>
