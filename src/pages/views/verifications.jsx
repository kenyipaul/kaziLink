    ...
    <Backdrop open={userInfoState.state}>
      <div className="user-review">
        <div className="header">
          ...
          <svg
            onClick={() => setUserInfoState({ state: false, userData: {} })}
            width="2rem"
            height="2rem"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <div className="form">
          ...
          <div className="display-group">
            <div className="display-area">
              <p>Date of Birth</p>
              <h3>
                {userInfoState.userData && userInfoState.userData.birthday}
              </h3>
            </div>
            <div className="display-area">
              <p>Location</p>
              <h3>
                {userInfoState.userData && userInfoState.userData.location}
              </h3>
            </div>
            <div className="display-area">
              <p>Gender</p>
      ...
      <div className="action">
        ...
        <div className="menu">
          <ul>
            <li
              onClick={() =>
                setUserInfoState({ state: true, userData: props.data })
              }
            >
              Review
            </li>
