...
export default function UsersDashboard() {
  ...
  const [showAddValues, setShowAddValues] = useState(false);
                ...
                >
                  ...
                  <g id="SVGRepo_iconCarrier">
                    ...
                    <path
                      ...
                      fill={verify ? "currentcolor" : "#ddd"}
                    ></path>{" "}
                  </g>
                </svg>
                {userState.verifyNumber ? "Verified" : "Not Verified"}
              </h3>
              <h3>
                <svg
                  width="1rem"
        ...
        <section>
          <div className="about-section section">
            <div className="header-bar">
              ...
              {editAbout ? (
                <button className="save" onClick={() => HandleAddAboutValues()}>
                  Save
                </button>
              ) : (
                <button className="edit" onClick={() => setEditAbout(true)}>
                  <svg
                    width="1.2rem"
                    height="1.2rem"
                    viewBox="0 0 24 24"
          ...
          <div className="skill-section section">
            <h1>Values</h1>
            <div className="skill-grid">
              {userState.userData.values &&
                userState.userData.values.map((value) => {
                  return <p key={value}>{value}</p>;
                })}
              {/* <p>Honesty</p>
              <p>Good Communicator</p>
              <p>God Fearing</p> */}
              <div className="add_skill" onClick={() => setShowAddValues(true)}>
                <img src={add} alt="" />
              </div>
            </div>
          </div>
          ...
          <div className="work-history-section section">
            ...
            <div className="work-history-grid">
              <div className="work-history-skeleton">
                ...
                <p>
                  Start adding your work experience to showcase your skills and
                  achievements.
                </p>
          ...
          <div className="testimonial-section section">
            ...
            <div className="testimonial-grid">
              <div className="testimony-skeleton">
                ...
                <p>
                  Start collecting testimonials to showcase your positive
                  impact.
                </p>
              </div>
