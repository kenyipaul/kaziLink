...
function UnauthorizedNav() {
  ...
  return (
    <>
      ...
      {path == "/login/employer" && (
        <div className="navbar-buttons">
          <button onClick={() => navigate("/login")}>Login as Employer</button>
          <button onClick={() => navigate("/register")}>Register</button>
        </div>
      )}
    </>
...
function AuthorizedNav(props) {
  ...
  return (
    <div
      className={
        props.active
          ? `authorized-user-section active`
      ...
      <ul>
        {userState.userData && userState.userData.role == "employer" ? (
          <>
            ...
            <li>
              <Link className={path === "/create" ? "active" : ""} to="/create">
                Create a Job
              </Link>
            </li>
          </>
        ...
        {userState.userData && userState.userData.role == "employer" ? (
          <li>
            <Link
              className={path === "/employer/dashboard" ? "active" : ""}
          ...
          <li>
            <Link
              className={path === "/users/dashboard" ? "active" : ""}
              to="/users/dashboard"
              onClick={() => props.setMenuState()}
            >
              Profile
