            ...
            <ul>
                {
                    ...
                    <>
                        <li><Link className={path === "/workers" ? "active" : ""} to="/workers">Find a Worker</Link></li>
                        <li><Link className={path === "/create" ? "active" : ""} to="/create">Create a Job</Link></li>
                    </> :
                    <li><Link className={path === "/jobs" ? "active" : ""} to="/jobs">Find a Job</Link></li>
                }

                {
                    userState.userData && userState.userData.role == "employer" ?
                    <li><Link className={path === "/employer/dashboard" ? "active" : ""} to="/employer/dashboard">Profile</Link></li> :
                    <li><Link className={path === "/users/dashboard" ? "active" : ""} to="/users/dashboard">Profile</Link></li>
                }
            </ul>
