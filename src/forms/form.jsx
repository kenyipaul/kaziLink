      ...
      <div className="form-view">
        ...
        <div className="skill-area">
          ...
          <div className="skill-grid">
            <p className={skills.includes("House Cleaning") ? "skill active" : "skill"} onClick={()=> FilterSkills("House Cleaning")}>House Cleaning</p>  
            <p className={skills.includes("Plumbing") ? "skill active" : "skill"} onClick={()=> FilterSkills("Plumbing")}>Plumbing</p>
            <p className={skills.includes("Carpentry") ? "skill active" : "skill"} onClick={()=> FilterSkills("Carpentry")}>Carpentry</p>
            <p className={skills.includes("Painting") ? "skill active" : "skill"} onClick={()=> FilterSkills("Painting")}>Painting</p>
            <p className={skills.includes("Roofing") ? "skill active" : "skill"} onClick={()=> FilterSkills("Roofing")}>Roofing</p>
            <p className={skills.includes("Electrical") ? "skill active" : "skill"} onClick={()=> FilterSkills("Electrical")}>Electrical</p>
          </div>
        </div>
